...
const SITE = process.env.FLUX_SITE || 'https://flux-mac2313.pages.dev';
...
try {
  ...
  console.error('A 404 means the live build predates version stamping, or nothing is published yet.');
  process.exit(2);
}
